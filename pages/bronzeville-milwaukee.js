...
const restaurants = [
  ...
  },
  {
    ...
    cuisine: "Bakery",
    priceRange: "$",
    address: "North Ave area, Milwaukee, WI 53212",
    description: "Small-batch artisan donuts made fresh daily. Creative flavors and quality ingredients make this a neighborhood favorite. Black-owned business supporting the Bronzeville community.",
    mustTry: "Daily specials, creative flavors",
    bestFor: "Breakfast, sweet treats, supporting local",
    insiderTip: "They sell out—go early for the best selection.",
  },
];
