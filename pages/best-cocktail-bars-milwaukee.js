...
const cocktailBars = {
  speakeasies: [
    ...
    },
    {
      ...
      priceRange: "$$",
      address: "Accessed through a bookcase in a different bar",
      description: "Milwaukee's answer to a Prohibition-era speakeasy—accessed through a bookcase in another establishment. Creative cocktails named after Milwaukee landmarks, served in an intimate basement setting.",
      mustTry: "Milwaukee-named cocktails, classic preparations",
      insiderTip: "Ask around to find the entrance. Part of the fun is discovering it.",
      bestFor: "Secret bar hunters, creative cocktails, unique experiences",
      atmosphere: "Hidden, intimate, playful",
    },
    {
      name: "Mosler's Vault",
      neighborhood: "Lower East Side",
      style: "Bank Vault Speakeasy",
      priceRange: "$$-$$$",
      address: "North Avenue Market",
      description: "A modern speakeasy tucked inside a former bank vault at North Avenue Market. The unique setting—complete with the original vault door—creates an atmosphere unlike anywhere else in Milwaukee.",
      mustTry: "Signature cocktails, small plates",
      insiderTip: "The vault door is original. The intimate setting makes reservations a good idea.",
      bestFor: "Unique settings, craft cocktails, Instagram-worthy",
      atmosphere: "Unique, intimate, modern",
    },
  ],
  craftCocktails: [
    {
      ...
      description: "A haven for cocktail aficionados featuring exceptional drinks in a refined setting. Station No. 06 showcases quality ingredients and innovative techniques that put it among the best cocktail bars in the region.",
      mustTry: "Seasonal menu, classic cocktails done right, bartender recommendations",
      insiderTip: "Ask about off-menu cocktails. The bartenders love showcasing their creativity.",
  ...
  unique: [
    {
      ...
      description: "Milwaukee's Japanese corner bar offering Japanese-inspired cocktails in an intimate setting. The attention to detail—from ice to glassware to technique—reflects Japanese cocktail culture.",
      ...
      <div style={{ backgroundColor: c.cream, minHeight: "100vh" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "40px 20px" }}>
          <nav style={{ marginBottom: "24px", fontSize: "0.9rem" }}>
            ...
            <span style={{ margin: "0 8px", color: "#999" }}>/</span>
            <span style={{ color: c.green1 }}>Best Cocktail Bars</span>
          </nav>
