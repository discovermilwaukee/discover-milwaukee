...
// inline emphasis).
const body = [
  { p: "A few weeks ago, I was walking through the Historic Third Ward on one of those summer afternoons that reminds you why people love Milwaukee. The patios were busy, people wandered in and out of shops, and families were making their way toward the lakefront. It felt alive, and honestly, it made me stop for a second just to take it all in." },
  { p: "Then I looked up." },
  { p: (<>I saw the concrete ramps, the overpasses, and the stretch of I-794 cutting through the middle of it all. I remember standing there thinking, <em>Have we just gotten used to this?</em> Not because I suddenly had all the answers, but because I found myself wondering what this part of the city could feel like if it brought people together instead of dividing them.</>) },
  ...
  { p: "Before I go any further, I want to be clear about something. I’m not an urban planner, a transportation engineer, or an economist. The people who do those jobs know far more than I ever will, and I genuinely hope WisDOT, city leaders, developers, neighborhood organizations, business owners, and residents continue asking hard questions before any decision is made." },
  { p: "I’m simply writing from a different perspective." },
  { p: "Sixteen years ago, I came to Milwaukee to attend the University of Wisconsin-Milwaukee. Like a lot of college students, I assumed I’d earn my degree and eventually end up somewhere else. Instead, Milwaukee became home. It’s where I met my wife, built my career, and where my wife and I eventually started Discover Milwaukee. Today, it’s where we’re raising our family." },
  { p: "Over the years, Discover Milwaukee has taken us to just about every corner of this city. We’ve met the people behind family-owned restaurants, neighborhood coffee shops, bars, festivals, parks, and small businesses that make Milwaukee what it is. We’ve watched visitors experience the city for the first time and locals discover places they never knew existed in their own backyard." },
  { p: "When my wife and I started Discover Milwaukee, we weren’t trying to build a brand. We simply wanted more people to see the city the way we had come to see it." },
  { p: "The longer we did it, the more my relationship with Milwaukee changed. I stopped looking at neighborhoods as individual destinations and started seeing how they fit together. Someone spending the afternoon in the Historic Third Ward naturally wanders to the RiverWalk. A walk along the lakefront turns into dinner in Walker’s Point. One great experience leads to another. Once you start looking at Milwaukee that way, it’s hard not to imagine what else this city could become." },
  ...
  { p: "Traffic matters. Construction impacts matter. Taxpayer dollars matter. If Milwaukee removes I-794 without a clear vision for what comes next, that’s a risk we shouldn’t ignore. I think everyone, whether they support removing it or preserving it, should be able to agree on that." },
  ...
  { p: "Most of the conversation around I-794 has focused on traffic, and that’s understandable. Nobody enjoys sitting in traffic. I don’t either. But when I think about the cities I’ve loved visiting, I honestly can’t remember how quickly I got through them. I remember how they made me feel. I remember wandering. I remember discovering places I never planned to visit. I remember wanting to stay longer than I intended." },
  ...
  { p: "Will this make Milwaukee feel more connected? Will it create new opportunities for local businesses? Will it encourage people to spend another hour downtown instead of heading home? Will it inspire someone graduating from UW-Milwaukee to build a life here the way I did?" },
