        ...
        <section style={{ padding: isMobile ? "40px 16px" : "80px 16px", backgroundColor: c.green1 }}>
          <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
            ...
            <div style={{ marginBottom: isMobile ? "32px" : "48px" }}>
              ...
              <div style={{ 
                display: "grid", 
                gridTemplateColumns: isMobile ? "repeat(3, 1fr)" : partners.length > 0 ? `repeat(${Math.min(partners.length, 10)}, 1fr)` : "repeat(10, 1fr)", 
                  ...
                  partners.map((partner, i) => (
                    ...
                    >
                      {partner.logoUrl ? (
                        ...
                        <span style={{ color: c.green1, fontSize: "10px", fontWeight: "700", textAlign: "center", padding: "4px" }}>{partner.name}</span>
                      )}
                    </a>
                  ))
                ) : (
