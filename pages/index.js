...
export default function DiscoverMilwaukee() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: c.cream, fontFamily: "system-ui, sans-serif" }}>
      ...
      {/* FOOTER */}
      <footer style={{ padding: isMobile ? "32px 16px" : "40px 16px", backgroundColor: c.green1, borderTop: `4px solid ${c.yellow}` }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", flexDirection: isMobile ? "column" : "row", justifyContent: "space-between", alignItems: isMobile ? "center" : "center", textAlign: isMobile ? "center" : "left", gap: "20px" }}>
          <div>
