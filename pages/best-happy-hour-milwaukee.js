...
const happyHourSpots = [
  ...
  { name: "Miller Time Pub & Grill", region: "downtown", neighborhood: "Westown (Hilton Milwaukee)", priceRange: "$-$$", address: "509 W Wisconsin Ave, Milwaukee, WI 53203", days: ["mon", "tue", "wed", "thu"], daysLabel: "Mon–Thu 4–7 p.m. (call to confirm any late-night specials)", drinkSpecials: "$5 rail cocktails, $4 Miller taps, $5 house wine · Game-day: $5 Miller Lite drafts during Brewers home games, $6 pints during Bucks home games (wear team gear)", foodSpecials: "$2 off select appetizers", description: "Downtown pub attached to the Hilton Milwaukee City Center, steps from the Wisconsin Center and downtown theaters.", insiderTip: "Great spot before a show at the Riverside or Pabst Theater. Game-day deals kick in for Brewers and Bucks home games.", tags: ["beer", "sports", "hotel"] },
  { name: "Birch", region: "brewers-hill", neighborhood: "Brewer's Hill / Lower East Side", priceRange: "$$$", address: "459 E Pleasant St, Milwaukee, WI 53202", days: ["tue", "wed", "thu", "fri"], daysLabel: "Tue–Fri 4–6 p.m. (bar only)", drinkSpecials: "Bar HH menu — call (414) 323-7372 to confirm current pricing", foodSpecials: "Bar-only menu items — call to confirm current pricing", description: "High-end tasting-menu restaurant with a bar-only happy hour — a way to experience Birch without the full prix-fixe commitment.", insiderTip: "Sit at the bar and trust the bartender. Reservations not required at the bar during HH; specifics rotate.", tags: ["cocktails", "wine", "food"] },
  { name: "Bryant's Cocktail Lounge", region: "south-side", neighborhood: "Historic Mitchell Street", priceRange: "$$", address: "1579 S 9th St, Milwaukee, WI 53204", days: ["sun", "tue", "wed", "thu"], daysLabel: "Sun + Tue–Thu evenings (closed Mondays — call to confirm the HH window)", drinkSpecials: "$5 Old Fashioneds and Depression-era cocktails", foodSpecials: "No food served — drinks only", description: "Milwaukee's oldest cocktail lounge, in business since 1938. No printed cocktail menu — tell the bartender what you like.", insiderTip: "Closed Mondays — show up Sun or Tue–Thu. Describe a mood (\"something bourbon-forward\") and the bartender takes it from there.", tags: ["cocktails"] },
  { name: "Hooligan's Super Bar", region: "east-side", neighborhood: "Lower East Side", priceRange: "$", address: "2017 E North Ave, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 3–6 p.m.", drinkSpecials: "$1 off all taps, $1 off bottles/cans, $1 off wine, $2 off mixers and rails", foodSpecials: "Half-priced appetizers", description: "East Side neighborhood institution at Farwell & North. Deep tap list and 100-plus bottles/cans, all $1 off during HH.", insiderTip: "Half-priced apps + $1 off taps for three hours is one of the best beer-and-bar-food values on the East Side.", tags: ["beer", "food", "sports"] },
  { name: "The Vanguard", region: "bay-view", neighborhood: "Bay View", priceRange: "$$", address: "2659 S Kinnickinnic Ave, Milwaukee, WI 53207", days: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], daysLabel: "Daily — bourbon deals + $2 cans always on", drinkSpecials: "Daily bourbon: $2 shot / $3 mixed / $4 pour Sun–Thu · $3 shot / $4 mixed / $6 pour Fri–Sat · $2 PBR / Rhinelander / Milwaukee Classic Lager always", foodSpecials: "Rotating themed food specials (call to confirm the current weeknight schedule)", description: "Craft sausage spot with a rotating daily drink program instead of a fixed HH window.", insiderTip: "Ask the bartender what bourbon is on. The Duck Bacon Jalapeño sausage is a longtime favorite.", tags: ["beer", "cocktails", "food"] },
  { name: "Mason Street Grill", region: "downtown", neighborhood: "East Town (The Pfister)", priceRange: "$$$", address: "425 E Mason St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4:00–6:30 p.m. (Mon extends later — Industry Night; call to confirm)", drinkSpecials: "$2 drafts, $3 well mixed drinks, $5 martinis, $5–$7 wine by the glass", foodSpecials: "$5–$7 bar bites / appetizers", description: "Hotel-bar HH inside The Pfister, with live jazz on most nights. The closest thing to a grand-hotel HH downtown. Monday Industry Night extends the HH later (call to confirm the current window).", insiderTip: "Monday Industry Night runs one of the longest single-day windows in this guide. Live jazz often starts before HH ends — call to confirm the schedule.", tags: ["cocktails", "wine", "hotel"] },
  { name: "The Bar at Saint Kate", region: "downtown", neighborhood: "East Town (Saint Kate)", priceRange: "$$", address: "139 E Kilbourn Ave, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu"], daysLabel: "Mon–Thu 3–5 p.m. (call to confirm the bites window)", drinkSpecials: "Deals on select wines by the glass / by the bottle, tap beer (call to confirm specifics)", foodSpecials: "Shareable apps during the HH window (call to confirm timing)", description: "Arts-hotel lobby bar with rotating gallery, sushi and Proof Pizza. Live music at 5 p.m. nightly — HH ends as live music starts.", insiderTip: "If you stay through 5, you get the music for free. THC-infused drink options are on the menu.", tags: ["cocktails", "wine", "hotel"] },
  { name: "The Outsider (rooftop)", region: "third-ward", neighborhood: "Third Ward (Kimpton Journeyman)", priceRange: "$$$", address: "310 E Chicago St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4–6 p.m. (seasonal — rooftop)", drinkSpecials: "$10 Outsider Originals — signature fruit-infused cocktails (Keylime Sangria, Tangerine Mirage)", foodSpecials: "Shareable small plates and snacks", description: "9th-floor rooftop atop the Kimpton Journeyman Hotel. The best rooftop HH downtown — Third Ward views.", insiderTip: "Lines build by 8 p.m. on summer Fridays — get there closer to 5 for HH pricing and seat options. Thursday DJ nights run later in the evening (call to confirm).", tags: ["cocktails", "rooftop", "hotel"] },
  ...
  { name: "Lupi & Iris", region: "downtown", neighborhood: "East Town", priceRange: "$$$", address: "777 N Van Buren St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon 3–8:30 p.m.; Tue–Fri 3–6 p.m. (bar area)", drinkSpecials: "$4 select beers, $7 select wines, $9 select cocktails (bar area only)", foodSpecials: "Bar HH menu (call to confirm specifics)", description: "Mediterranean / Coastal restaurant from James Beard Award–winning chef Adam Siegel (2008 Best Chef: Midwest), near the lakefront.", insiderTip: "Sit at the bar for the HH menu. Siegel's pedigree shows in the food — the bar is one of the best ways to taste the menu without the prix-fixe commitment.", tags: ["cocktails", "wine", "international"] },
  { name: "Tupelo Honey", region: "third-ward", neighborhood: "Third Ward", priceRange: "$$", address: "511 N Broadway, Suite 100, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4–6 p.m. (Hoot & Holler HH)", drinkSpecials: "$5 well spirits, $2 off beers and glasses of wine, plus select HH cocktails; themed weeknights: Mimosa Monday ($2 off mimosas), 'Tini Tuesday ($3 gin/vodka martinis & cosmos), Wine Wednesday (½-off bottles), Tequila Thursday ($6 margaritas)", foodSpecials: "Half-off appetizers + HH bites (crispy brussels, fried pickles, fried green tomatoes, cauliflower tacos)", description: "Southern kitchen with a broad HH drink-and-food deal list downtown. Themed weekly nights run alongside the daily HH.", insiderTip: "Weeknight themes rotate — Tuesday martinis, Wednesday wine, Thursday margaritas are recurring patterns but specifics shift; call ahead.", tags: ["food", "cocktails", "wine"] },
  { name: "The Wicked Hop", region: "third-ward", neighborhood: "Third Ward", priceRange: "$$", address: "345 N Broadway, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri", "sun"], daysLabel: "Mon–Fri 4–6 p.m. + all-day Tuesday; Sunday 4–9 p.m.", drinkSpecials: "$1 off taps and bottles · Tue all-day: $7 select cocktails, $9 select apps", foodSpecials: "Taqueria Thursday ($4 Modelo tall boys, Milagro shots); Friday Fish Fry", description: "Third Ward's oldest building (1875, Jewett & Sherman). The all-day HH on Tuesdays is the standout — Mon, Wed, Thu, Fri run the standard 4–6 p.m. window, and Sunday runs a long 4–9 p.m. window.", insiderTip: "Tuesday all-day pricing is the steal ($7 cocktails, $9 apps). Sunday's 4–9 p.m. window is one of the longest Sunday HHs in Milwaukee.", tags: ["beer", "cocktails", "food", "weekend"] },
  ...
  { name: "At Random", region: "bay-view", neighborhood: "Bay View", priceRange: "$$", address: "2501 S Delaware Ave, Milwaukee, WI 53207", days: ["tue", "wed", "thu"], daysLabel: "Tue–Thu evenings (call to confirm current HH window)", drinkSpecials: "Discounted ice cream cocktails (regularly ~$13) — call to confirm current HH pricing", foodSpecials: "No kitchen — drinks only", description: "Historic Bay View cocktail lounge — the building has been a tavern since the 1890s and \"At Random\" since 1964. Ice cream cocktails are the calling card.", insiderTip: "Dim, vintage, no kids allowed. The Pink Squirrel (invented by Bryant's down the road) and Tin Roof are the orders. Cash adds to the vibe.", tags: ["cocktails"] },
  ...
  { name: "Avli", region: "brewers-hill", neighborhood: "Brewer's Hill", priceRange: "$$", address: "1818 N Hubbard St, Milwaukee, WI 53212", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4–6 p.m.", drinkSpecials: "HH menu of cocktails, wines and small plates (call to confirm pricing)", foodSpecials: "Greek meze small plates featured", description: "Greek small-plates restaurant with a wine-forward bar and a seasonal patio in Brewer's Hill.", insiderTip: "The patio is the right call when weather allows. Sit at the bar for the meze-and-wine HH menu.", tags: ["wine", "cocktails", "international", "food"] },
  ...
  { name: "BelAir Cantina — Water St", region: "east-side", neighborhood: "Lower East Side (Brady-adjacent)", priceRange: "$$", address: "1935 N Water St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], daysLabel: "Daily 3–7 p.m. · Late-night 9–11 p.m. Thu–Sat only (Water St)", drinkSpecials: "Late-night (Thu–Sat, Water St only): $5 margaritas, $3 tequila shots, $6 specialty cocktails", foodSpecials: "Late-night (Thu–Sat): $6 queso blanco fundido, $5 nachos, $3 walkin' tacos, $5 guacamole · $3 tacos on Taco Tue & Thu (call to confirm current pricing and Burrito Monday deal)", description: "Mexican spot with one of the city's only real late-night HH windows — Thu–Sat 9–11 p.m. specifically at the Water St location (other locations close earlier).", insiderTip: "The 9–11 p.m. window is Thu/Fri/Sat only at Water St — other days the venue closes at 10. Call ahead to confirm the daytime HH window and daily specials.", tags: ["cocktails", "food", "late-night", "international"] },
  { name: "The Diplomat", region: "east-side", neighborhood: "Brady Street", priceRange: "$$$", address: "815 E Brady St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon all-night bar HH; Tue–Fri evenings (call to confirm exact window)", drinkSpecials: "Wine-focused HH menu (Wine Spectator award winner) — call to confirm pricing", foodSpecials: "Shareable American small plates — chef Dane Baldwin (2022 James Beard Best Chef: Midwest)", description: "Chef-driven Brady Street restaurant from James Beard winner Dane Baldwin. Often cited among Milwaukee's best HH for quality of bar food.", insiderTip: "Reservations not required at the bar for HH. The wine list is the reason — splurge on a glass during HH pricing.", tags: ["wine", "cocktails", "food"] },
  ...
  { name: "Movida at Hotel Madrid", region: "walkers-point", neighborhood: "Walker's Point", priceRange: "$$", address: "600 S 6th St, Milwaukee, WI 53204", days: ["wed", "thu", "fri", "sat", "sun"], daysLabel: "Wed–Sun 4–6 p.m. at the bar (closed Mon & Tue)", drinkSpecials: "$9 sangrias (red/white/tequila) — call to confirm current pricing and weekly specials", foodSpecials: "$1 tapas (jamon croquetas, pan con tomate) plus $3 and $5 tapas tiers", description: "Spanish tapas in the Hotel Madrid with a rooftop patio. The $1 tapas at the bar is one of the best food deals in Milwaukee.", insiderTip: "Hand-carved jamon and the $1 tapas are the move. Rooftop patio in season. Note the venue is closed Monday and Tuesday.", tags: ["wine", "food", "international", "rooftop", "hotel"] },
  { name: "Iron Horse Hotel — Branded", region: "walkers-point", neighborhood: "Walker's Point (Iron Horse Hotel)", priceRange: "$$", address: "500 W Florida St, Milwaukee, WI 53204", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4–6 p.m. (call to confirm)", drinkSpecials: "$5 Milwaukee tall boys · $5 drafts · $5 off specialty cocktails · half-off house wine and house liquor pours", foodSpecials: "Half-off apps", description: "The Iron Horse Hotel's pub-style HH with pool, shuffleboard, foosball and arcade games. Patio at The Yard expands the HH in season.", insiderTip: "Walker's Point is dense around the Iron Horse — walk to Camino, MobCraft or Bryant's after.", tags: ["cocktails", "beer", "food", "hotel"] },
  ...
  { name: "Three Lions Pub", region: "suburbs", neighborhood: "Shorewood", priceRange: "$$", address: "4515 N Oakland Ave, Shorewood, WI 53211", days: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], daysLabel: "Daily 4–6 p.m.", drinkSpecials: "Up to 40% off taps, wine, specialty cocktails · Fri \"Old Fashioned Friday\" $6 all day · rotating weeknight specials (Wed craft-beer/shot deals, Thu wings — call to confirm current pricing)", foodSpecials: "Up to 40% off appetizers", description: "British pub with a 7-day-a-week HH — the most consistent suburban option. Long beer list and pub trivia Wednesday.", insiderTip: "Old Fashioned Friday ($6 all day) is the trip-up to Shorewood worth making. 40% off is steep — the deal is real.", tags: ["beer", "cocktails", "food", "weekend"] },
  { name: "Camp Bar — Shorewood", region: "suburbs", neighborhood: "Shorewood", priceRange: "$$", address: "4044 N Oakland Ave, Shorewood, WI 53211", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri evenings + nightly specials (call to confirm the current window)", drinkSpecials: "HH drink specials including Old Fashioneds (call to confirm pricing)", foodSpecials: "Call to confirm food deals", description: "Supper-club-vibes lodge bar on the North Shore, with nightly drink specials running after the regular HH.", insiderTip: "Old Fashioneds are the order — this is supper-club territory. Camp's Third Ward location runs a different HH structure.", tags: ["cocktails", "late-night"] },
  { name: "Gathering Place Brewing", region: "brewers-hill", neighborhood: "Riverwest", priceRange: "$", address: "811 E Vienna Ave, Milwaukee, WI 53212", days: ["mon", "tue", "wed"], daysLabel: "Mon–Wed 4–6 p.m.", drinkSpecials: "$2 off full pours", foodSpecials: "No full kitchen (bring outside food)", description: "Riverwest brewery taproom with a rare early-week HH. Dog-friendly, neighborhood-feel.", insiderTip: "Bring outside food — they encourage it. Walk to Lakefront Brewery after for the full Riverwest beer crawl.", tags: ["beer", "brewery"] },
];

const faqs = [
  {
    question: "What are the best happy hour deals in Milwaukee?",
    answer: "Top all-around Milwaukee happy hour deals include Aperitivo (flat $8 wines/cocktails/small plates Tue–Thu 4–6 + Fri 4–5), Black Sheep ($5 Wheatley martinis + Four Roses Manhattans + house wine, $10 cheese board Mon–Thu), Maxie's ($2 oysters, $9 select apps, $1 off all drinks Mon–Sat 4–6), Hooligan's ($1 off taps/bottles/wine + half-price apps Mon–Fri 3–6), Tupelo Honey (half-off starters + HH drinks Mon–Fri 4–6 with rotating themed weeknights), Lupi & Iris ($4 beer / $7 wine / $9 cocktails Mon–Fri 3–6 from James Beard winner Adam Siegel), and Three Lions Pub in Shorewood (daily 4–6 with up to 40% off everything)."
  },
  {
    question: "What time does happy hour start in Milwaukee?",
    answer: "Most Milwaukee HHs run weekday 4–6 p.m. The earliest starts are Camino (2 p.m. Mon–Fri), Story Hill BKC (2 p.m. Tue–Sat) and Tre Rivali (2 p.m. Mon–Fri at the Kimpton Journeyman). The Wicked Hop runs all-day HH on Tuesdays (Sunday runs a long 4–9 p.m. window). One of the longest single-day HHs is Mason Street Grill's Monday Industry Night inside The Pfister, which extends the HH later into the evening (call to confirm the window). For late-night, BelAir Cantina Water St runs a 9–11 p.m. window Thu–Sat."
  },
  {
    question: "Where is happy hour open on Sunday in Milwaukee?",
    answer: "Sunday happy hour is rare in Milwaukee. Confirmed Sunday HH spots: Von Trier (daily 4–6 p.m. — includes Sunday), The Vanguard (daily bourbon deal), Foundation Bar in Riverwest (daily 5–10 p.m.), Lost Whale Bay View (daily 4–6 p.m.), BelAir Cantina Water St (daily 3–7 p.m.), Three Lions Pub Shorewood (daily 4–6 p.m.), Bryant's Cocktail Lounge (Sunday evenings with $5 Old Fashioneds — call to confirm the window), The Wicked Hop (Sunday 4–9 p.m.), and Boone & Crockett (Sunday all-day HH — the city's standout Sunday move with $5 Luxardo Manhattans)."
  },
  {
    question: "Where can I get cheap drinks in Milwaukee?",
    answer: "For pure value: Hooligan's Super Bar on the East Side ($1 off taps/bottles/wine, $2 off mixers Mon–Fri 3–6 p.m.), Palomino Bar in Bay View ($2 PBR tall boys, $6 beer-and-shot combo always), Foundation Bar in Riverwest ($3 taps and rails 5–10 p.m. daily), Camino in Walker's Point (2-for-1 tall boys + half-off pierogi Mon–Fri 2–5 p.m.), The Vanguard ($2 PBR/Rhinelander/Milwaukee Classic Lager always), and Miller Time Pub downtown ($5 rails / $4 Miller taps Mon–Thu 4–7). Burnhearts' $8 four-pour sampler is the craft-beer value play in Bay View."
  },
  {
    question: "What Milwaukee bars have the best happy hour food?",
    answer: "Movida at Hotel Madrid in Walker's Point runs $1 tapas at the bar (Wed–Sun 4–6) — arguably the best food deal in the city. Maxie's has $2 oysters and $9 select apps Mon–Sat 4–6. Tupelo Honey has half-off starters plus HH bites Mon–Fri 4–6. Hooligan's runs half-priced apps Mon–Fri 3–6. BelAir Cantina Water St's late-night 9–11 p.m. (Thu–Sat) brings $3 walkin' tacos and $5 nachos. The Wicked Hop runs all-day Tuesday $9 select apps. Camino does half-off pierogi Mon–Fri 2–5. Black Sheep's $10 cheese board (Mon–Thu) is the wine-pairing classic."
  },
  {
    question: "What are the best rooftop and patio happy hours in Milwaukee?",
    answer: "The Outsider rooftop atop the Kimpton Journeyman in the Third Ward (Mon–Fri 4–6, $10 fruit-infused signature cocktails) is the city's best rooftop HH. Uncle Bucks on Third's rooftop in the Deer District has the Tue–Fri 4–7 HH (suspended on Fiserv event nights). Boone & Crockett's riverside patio in Walker's Point is the standout outdoor cocktail bar — Sunday all-day HH. Von Trier's biergarten and Café Hollander Downer's patio cover the East Side. Movida's rooftop at Hotel Madrid hosts $1 tapas Wed–Sun. Lost Whale's Bay View backyard runs daily 4–6 with half-off taps and cocktails."
  },
  {
    question: "What hotel bars have happy hour in Milwaukee?",
    answer: "Mason Street Grill inside The Pfister (Mon–Fri 4–6:30; Mon extends later for Industry Night — $2 drafts / $3 wells / $5 martinis / $5–$7 wine + live jazz most nights). The Bar at Saint Kate Arts Hotel (Mon–Thu 3–5 + live music starting at 5 — call to confirm the bites window). The Outsider at Kimpton Journeyman (rooftop, Mon–Fri 4–6). Tre Rivali at Kimpton Journeyman (Mon–Fri 2–6 bar/patio HH). Branded at The Iron Horse Hotel in Walker's Point (Mon–Fri 4–6 — call to confirm specials). Movida at Hotel Madrid (Wed–Sun 4–6, $1 tapas)."
  },
  {
    question: "Where can I find late-night happy hour in Milwaukee?",
    answer: "True late-night HH is rare in Milwaukee. Confirmed: BelAir Cantina Water St runs a 9–11 p.m. late-night HH Thu–Sat (Lower East Side) with $5 margaritas, $3 tequila shots, $6 specialty cocktails, plus discounted snacks. Foundation Bar in Riverwest runs HH till 10 p.m. daily. Camp Bar Shorewood adds nightly specials after the regular HH (call to confirm the window)."
  },
  {
  ...
  },
  {
    ...
    answer: "Tupelo Honey: rotating themed weeknights (Tue martinis, Wed wine, Thu margaritas — call to confirm). Three Lions Pub Shorewood: Wed $5 pints of 3 Sheeps + $3 Lemon Drops + $5 Deep Eddy Bombs; Fri \"Old Fashioned Friday\" $6 all day; Thu $1 traditional wings. Tre Rivali: rotating weekly wine deals (call to confirm). Boone & Crockett: Sun all-day HH ($5 Luxardo Manhattans). The Wicked Hop: Tue all-day HH ($7 cocktails, $9 apps) plus a long Sunday 4–9 p.m. window. Mason Street Grill: Mon Industry Night extends the HH later in the evening (call to confirm)."
  },
];

const BY_DAY_BEST = {
  mon: ["Mason Street Grill", "Hooligan's Super Bar", "Lupi & Iris", "Three Lions Pub", "Black Sheep"],
...
const REGION_BLURBS = {
  downtown: "Downtown and the Deer District cluster around Fiserv Forum, The Pfister, and Wisconsin Ave — hotel bars, game-day pre-parties, and the city's rare late-night happy hours.",
  "third-ward": "The Historic Third Ward has Milwaukee's most stylish happy hours — rooftop cocktails at the Kimpton Journeyman, Italian aperitivo, and Southern bites along Broadway.",
  "east-side": "The Lower East Side and Downer Ave lean neighborhood-bar and beer-hall — big tap lists, free popcorn, and some of the best-value happy hours in the city.",
  "brewers-hill": "Brewer's Hill and Riverwest run creative and low-key — a tiki bar, brewery taprooms, and Greek small plates with rare early-week deals.",
  "walkers-point": "Walker's Point is the densest happy-hour crawl in Milwaukee — Spanish tapas, Polish pierogi, riverfront patios, and the Iron Horse all within a few blocks.",
  "bay-view": "Bay View's KK corridor is cocktail country — daily Old Fashioneds, vintage ice-cream drinks, dive-bar combos, and backyard patios.",
  "south-side": "The South Side and Historic Mitchell Street hold Milwaukee's oldest cocktail lounge and beloved Mexican neighborhood spots.",
  "west-side": "The West Side and Story Hill offer long weekday windows, tap cocktails, and Southern oysters just west of downtown.",
  suburbs: "Shorewood and the North Shore run the most consistent 7-day happy hours — British-pub deals and supper-club Old Fashioneds.",
};
...
const navLinks = [
  ...
  { href: "#by-neighborhood", label: "By Neighborhood" },
  { href: "#faq", label: "FAQ" },
];
  ...
  return (
    <>
      <Head>
        ...
        <meta property="article:modified_time" content="2026-08-01T00:00:00-05:00" key="article:modified_time" />
      ...
      <div style={{ backgroundColor: c.cream, minHeight: "100vh" }}>
        <header style={{ background: `linear-gradient(135deg, ${c.green1} 0%, ${c.green2} 100%)`, padding: "60px 24px 48px", textAlign: "center" }}>
          <div style={{ maxWidth: "820px", margin: "0 auto" }}>
            <p style={{ color: c.orange, fontSize: "14px", fontWeight: "700", letterSpacing: "3px", marginBottom: "12px" }}>UPDATED AUGUST 1, 2026 · 37 VERIFIED SPOTS</p>
            ...
            <p style={{ color: c.beige, fontSize: "19px", lineHeight: 1.6, maxWidth: "680px", margin: "0 auto" }}>
              <strong>37 verified spots</strong> across every neighborhood — exact days, times, drink and food prices. Filter by day of week, neighborhood, or what you're looking for (cocktails, rooftop, late-night, hotel bar, oysters). All 37 spots re-verified against each venue's own website in August 2026.
            </p>
          </div>
        </header>
        ...
        <main style={{ maxWidth: "880px", margin: "0 auto", padding: "40px 24px" }}>
          ...
          <div style={{ backgroundColor: c.yellow, padding: "20px", borderRadius: "12px", marginBottom: "40px" }}>
            <p style={{ color: c.green1, fontSize: "14px", fontWeight: "600", margin: 0 }}>
              <strong>Heads up:</strong> All 37 spots below were re-verified against each venue's own website in August 2026 — but happy-hour times, prices and food specials shift frequently with seasons, ownership changes, and game-day schedules. Always call ahead before you go, especially for Sunday/Monday plans (most HH is weekday) and for Deer District spots on Fiserv Forum event nights (some HHs are suspended).
            </p>
          </div>
          ...
          <section id="key-facts" aria-labelledby="key-facts-heading" style={{ backgroundColor: c.cream, border: `1px solid ${c.beige}`, padding: "20px 24px", borderRadius: "14px", marginBottom: "32px", scrollMarginTop: "80px" }}>
            ...
            <dl style={{ display: "grid", gridTemplateColumns: "max-content 1fr", gap: "10px 18px", margin: 0, fontSize: "14px", lineHeight: 1.5 }}>
              ...
              <dd style={{ color: "#444", margin: 0 }}>37 across 9 Milwaukee neighborhoods</dd>
              ...
              <dd style={{ color: "#444", margin: 0 }}>Mason Street Grill (Mon Industry Night — extended evening window; call to confirm)</dd>
              <dt style={{ color: c.green1, fontWeight: "700" }}>Best late-night</dt>
              <dd style={{ color: "#444", margin: 0 }}>BelAir Water St (Thu–Sat 9–11 p.m.), Foundation Bar (daily till 10 p.m.)</dd>
            </dl>
            <p style={{ fontSize: "11px", color: "#999", margin: "14px 0 0" }}>
              All 37 spots re-verified <time dateTime="2026-08-01">2026-08-01</time> against each venue&apos;s own website and Milwaukee press.
            </p>
          </section>
          ...
          <section id="at-a-glance" style={{ marginBottom: "56px", scrollMarginTop: "80px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "12px" }}>
              {[
                ...
                { label: "Longest single-day HH", value: "Mason Street Grill (Mon Industry Night — extended window) · Foundation Bar (daily 5–10)" },
                ...
                { label: "Best late-night (after 9 p.m.)", value: "BelAir Water St (Thu–Sat 9–11), Foundation Bar (daily till 10)" },
          ...
          <section id="by-neighborhood" style={{ marginBottom: "56px", scrollMarginTop: "80px" }}>
            <h2 style={{ color: c.green1, fontSize: "30px", fontWeight: "900", marginBottom: "8px" }}>Happy Hour by Milwaukee Neighborhood</h2>
            <p style={{ color: "#666", fontSize: "16px", lineHeight: 1.7, marginBottom: "24px" }}>Where to drink by part of town — Downtown, Third Ward, East Side, Walker's Point, Bay View, Riverwest and beyond.</p>
            {REGIONS.filter((r) => r.id !== "all").map((r) => {
              const spots = happyHourSpots.filter((s) => s.region === r.id);
              if (spots.length === 0) return null;
              return (
                <div key={r.id} style={{ backgroundColor: "white", border: `1px solid ${c.beige}`, borderRadius: "14px", padding: "18px 20px", marginBottom: "14px" }}>
                  <h3 style={{ color: c.green1, fontSize: "20px", fontWeight: "800", margin: "0 0 6px" }}>Happy Hour in {r.label}</h3>
                  <p style={{ color: "#555", fontSize: "14px", lineHeight: 1.6, margin: "0 0 12px" }}>{REGION_BLURBS[r.id]}</p>
                  <ul style={{ margin: 0, paddingLeft: "18px", color: "#444", fontSize: "14px", lineHeight: 1.8 }}>
                    {spots.map((s) => (
                      <li key={s.name}><strong style={{ color: c.green1 }}>{s.name}</strong> — {s.daysLabel}</li>
                    ))}
                  </ul>
                </div>
              );
          ...
          <section style={{ marginBottom: "48px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "12px" }}>
              ...
              <Link href="/best-patios-milwaukee" style={{ display: "block", backgroundColor: c.green1, color: c.cream, padding: "16px", borderRadius: "10px", textDecoration: "none", fontWeight: "600", textAlign: "center" }}>Patios & Outdoor</Link>
              <Link href="/milwaukee-nightlife" style={{ display: "block", backgroundColor: c.green2, color: c.cream, padding: "16px", borderRadius: "10px", textDecoration: "none", fontWeight: "600", textAlign: "center" }}>Nightlife</Link>
