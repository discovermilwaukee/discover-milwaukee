      ...
      <div style={{ backgroundColor: c.cream, minHeight: "100vh" }}>
        <header style={{ background: `linear-gradient(135deg, ${c.green1} 0%, ${c.green2} 100%)`, padding: "60px 24px 48px", textAlign: "center" }}>
          <div style={{ maxWidth: "820px", margin: "0 auto" }}>
            <p style={{ color: c.orange, fontSize: "14px", fontWeight: "700", letterSpacing: "3px", marginBottom: "12px" }}>UPDATED AUGUST 1, 2026 · 36 VERIFIED SPOTS</p>
            ...
            <p style={{ color: c.beige, fontSize: "19px", lineHeight: 1.6, maxWidth: "680px", margin: "0 auto" }}>
              <strong>35+ verified spots</strong> across every neighborhood — exact days, times, drink and food prices. Filter by day of week, neighborhood, or what you're looking for (cocktails, rooftop, late-night, hotel bar, oysters). Top spots re-verified against each venue's own website August 1, 2026.
            </p>
          </div>
        </header>
        ...
        <main style={{ maxWidth: "880px", margin: "0 auto", padding: "40px 24px" }}>
          ...
          <div style={{ backgroundColor: c.yellow, padding: "20px", borderRadius: "12px", marginBottom: "40px" }}>
            <p style={{ color: c.green1, fontSize: "14px", fontWeight: "600", margin: 0 }}>
              <strong>Heads up:</strong> The most popular spots below were re-verified against the venue's own website in August 2026 (full list audited in 2026) — but happy-hour times, prices and food specials shift frequently with seasons, ownership changes, and game-day schedules. Always call ahead before you go, especially for Sunday/Monday plans (most HH is weekday) and for Deer District spots on Fiserv Forum event nights (some HHs are suspended).
            </p>
          </div>
          ...
          <section id="key-facts" aria-labelledby="key-facts-heading" style={{ backgroundColor: c.cream, border: `1px solid ${c.beige}`, padding: "20px 24px", borderRadius: "14px", marginBottom: "32px", scrollMarginTop: "80px" }}>
            ...
            <p style={{ fontSize: "11px", color: "#999", margin: "14px 0 0" }}>
              Top spots re-verified <time dateTime="2026-08-01">2026-08-01</time> against each venue&apos;s own website and Milwaukee press.
            </p>
          </section>
