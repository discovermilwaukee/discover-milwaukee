...
const happyHourSpots = [
  ...
  { name: "Black Sheep", region: "walkers-point", neighborhood: "Walker's Point", priceRange: "$$", address: "216 S 2nd St, Milwaukee, WI 53204", days: ["mon", "tue", "wed", "thu", "fri", "sat"], daysLabel: "Mon–Sat 4–6 p.m. (Fri extends 11 a.m.–6 p.m.)", drinkSpecials: "$5 Stoli martinis, $5 Four Roses Manhattans, $5 house wine, $5 sangria; Fri adds $4 drafts", foodSpecials: "$10 cheese board — Mon–Thu only", description: "Walker's Point staple. The extended Friday window (11 a.m.–6 p.m.) is the longest weekday HH in this guide.", insiderTip: "The $10 cheese board is the move — but go Mon–Thu (not Fri/Sat).", tags: ["cocktails", "wine", "food"] },
  { name: "Odd Duck", region: "walkers-point", neighborhood: "Walker's Point", priceRange: "$$", address: "939 S 2nd St, Milwaukee, WI 53204", days: ["tue", "wed", "thu", "fri", "sat"], daysLabel: "Tue–Sat 3–6 p.m.", drinkSpecials: "$5 draft beer, $8 wine by the glass", foodSpecials: "No formal HH menu — order from the ever-changing small-plates list", description: "Chef-driven restaurant that relocated from Bay View in 2022. The 3 p.m. start is the earliest HH window in this guide.", insiderTip: "Sit at the bar to watch the open kitchen. Whatever's marked seasonal is the order.", tags: ["wine", "beer", "food"] },
  ...
  { name: "Bryant's Cocktail Lounge", region: "south-side", neighborhood: "Historic Mitchell Street", priceRange: "$$", address: "1579 S 9th St, Milwaukee, WI 53204", days: ["sun", "mon", "tue", "wed", "thu"], daysLabel: "Sun–Thu ~5–7 p.m. (call to confirm)", drinkSpecials: "~$5 Old Fashioneds and Depression-era cocktails (call to confirm)", foodSpecials: "No food served — drinks only", description: "Milwaukee's oldest cocktail lounge, in business since 1938. No printed cocktail menu — tell the bartender what you like.", insiderTip: "Describe a mood (\"something bourbon-forward\") and the bartender takes it from there. Call (414) 383-2620 before you head out.", tags: ["cocktails"] },
  { name: "Hooligan's Super Bar", region: "east-side", neighborhood: "Lower East Side", priceRange: "$", address: "2017 E North Ave, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4–7 p.m.", drinkSpecials: "$1 off all taps, $1 off bottles/cans, $1 off wine, $2 off mixers and rails", foodSpecials: "Half-priced appetizers", description: "East Side neighborhood institution at Farwell & North. ~30 taps and 99+ bottles/cans, all $1 off during HH.", insiderTip: "Half-priced apps + $1 off taps for three hours is the best beer-and-bar-food value on the East Side.", tags: ["beer", "food", "sports"] },
  { name: "The Vanguard", region: "bay-view", neighborhood: "Bay View", priceRange: "$$", address: "2659 S Kinnickinnic Ave, Milwaukee, WI 53207", days: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], daysLabel: "Daily — bourbon deals + $2 cans always on", drinkSpecials: "Daily bourbon: $2 shot / $3 mixed / $4 pour Sun–Thu (+$1 each Fri–Sat); $2 PBR / Rhinelander / Milwaukee Classic Lager always", foodSpecials: "Daily themed sausage specials (Meatball Monday and similar — themes shift)", description: "Craft sausage spot with a rotating daily drink program instead of a fixed HH window.", insiderTip: "Ask the bartender what bourbon is on. The Duck Bacon Jalapeño sausage is a longtime favorite.", tags: ["beer", "cocktails", "food"] },
  { name: "Mason Street Grill", region: "downtown", neighborhood: "East Town (The Pfister)", priceRange: "$$$", address: "425 E Mason St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Weekdays 4:00–6:30 p.m.", drinkSpecials: "$2 drafts, $3 well mixed drinks, $5 martinis, $5–$7 wine by the glass", foodSpecials: "$5–$7 bar bites / appetizers", description: "Hotel-bar HH inside The Pfister, with smooth jazz playing live nightly. The closest thing to a grand-hotel HH downtown.", insiderTip: "Dress is casual but lean a notch up. Pair with the live music — it starts before HH ends.", tags: ["cocktails", "wine", "hotel"] },
  { name: "The Bar at Saint Kate", region: "downtown", neighborhood: "East Town (Saint Kate)", priceRange: "$$", address: "139 E Kilbourn Ave, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu"], daysLabel: "Mon–Thu 3–5 p.m.", drinkSpecials: "Deals on select wines by the glass / by the bottle, tap beer (call to confirm specifics)", foodSpecials: "Shareable apps featured", description: "Arts-hotel lobby bar with rotating gallery, sushi and Proof Pizza. Live music at 5 p.m. nightly — HH ends as live music starts.", insiderTip: "If you stay through 5, you get the music for free. THC-infused drink options are on the menu.", tags: ["cocktails", "wine", "hotel"] },
  { name: "The Outsider (rooftop)", region: "third-ward", neighborhood: "Third Ward (Kimpton Journeyman)", priceRange: "$$$", address: "310 E Chicago St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4–6 p.m. (seasonal — rooftop)", drinkSpecials: "$10 Outsider Originals — signature fruit-infused cocktails (Keylime Sangria, Tangerine Mirage)", foodSpecials: "Izakaya small plates (hatch chile crunch wings, caesar deviled eggs, cheese curds, smashburger)", description: "9th-floor rooftop atop the Kimpton Journeyman Hotel. The best rooftop HH downtown — Third Ward views.", insiderTip: "Walk-ins only and the line builds by 8 p.m. Get there at 5 for HH pricing + a couch. Sips & Sounds Thursdays 7:30–11:30 p.m.", tags: ["cocktails", "rooftop", "hotel"] },
  { name: "Tre Rivali", region: "third-ward", neighborhood: "Third Ward (Kimpton Journeyman)", priceRange: "$$$", address: "200 N Broadway, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 2–6 p.m. (bar or patio only)", drinkSpecials: "Cocktail and wine specials; Wednesdays half-price bottles of Mediterranean wine", foodSpecials: "\"Snack Hour\" Tue–Sat 2–5 p.m. — cicheti / shareables (warm olives, meatballs)", description: "Mediterranean restaurant in Kimpton Journeyman with one of the longest weekday HHs (4 hours). Half-price-bottle Wednesdays are the under-the-radar play.", insiderTip: "The patio on Broadway is great in summer. Wednesday bottle deal pairs perfectly with the snack hour.", tags: ["wine", "food", "hotel", "rooftop", "international"] },
  { name: "Lupi & Iris", region: "downtown", neighborhood: "East Town", priceRange: "$$$", address: "777 N Van Buren St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon 3–8:30 p.m. (extended); Tue–Fri 3–6 p.m.", drinkSpecials: "$4 select beers, $7 select wines, $9 select cocktails (bar area only)", foodSpecials: "Bar HH menu (call to confirm specifics)", description: "Mediterranean / Coastal restaurant near the lakefront with the longest single-day HH in Milwaukee — Mondays run 3 to 8:30 p.m.", insiderTip: "Mondays are the move. Sit at the bar and stretch a 5-hour HH into a real dinner.", tags: ["cocktails", "wine", "international"] },
  { name: "Tupelo Honey", region: "third-ward", neighborhood: "Third Ward", priceRange: "$$", address: "511 N Broadway, Suite 100, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 3–6 p.m. (Hoot & Holler HH)", drinkSpecials: "$3 select beers, $5 Sierra Nevada/Founders, $5 select cocktails, $5 wells, $7 house wines · Tue $3 martinis, Wed half-off bottles, Thu $6 margaritas", foodSpecials: "Half-off starters + $4 HH bites (crispy brussels, fried pickles, fried green tomatoes, cauliflower tacos)", description: "Southern kitchen with the broadest HH drink-and-food deal list downtown. Themed weekly nights run alongside the daily HH.", insiderTip: "Tuesday martinis at $3 are the steal. Wednesday wine bottles are half off — order the table some food and you've got dinner.", tags: ["food", "cocktails", "wine"] },
  { name: "The Wicked Hop", region: "third-ward", neighborhood: "Third Ward", priceRange: "$$", address: "345 N Broadway, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu"], daysLabel: "Mon–Thu 11 a.m.–7 p.m. (apps half off 3–5 p.m.)", drinkSpecials: "$1 off tap & bottle beers · $5 Three Olives highballs · $5 off select wine pours · Tue all-day: $7 cocktails, $9 apps", foodSpecials: "Half-off apps 3–5 p.m. Mon–Thu · Taqueria Thursdays · Friday Fish Fry", description: "Third Ward's oldest building (1875). One of the only true all-day HH windows in the city — Mon–Thu from open at 11 a.m.", insiderTip: "Tuesday all-day pricing is the move ($7 cocktails, $9 apps). Sat/Sun brunch adds $2 off mimosas 9–11 a.m.", tags: ["beer", "cocktails", "food", "weekend"] },
  { name: "Uncle Buck's Fish Bowl & Grill", region: "downtown", neighborhood: "Deer District", priceRange: "$$", address: "1125 N Dr Martin Luther King Jr Dr, Milwaukee, WI 53203", days: ["tue", "wed", "thu", "fri"], daysLabel: "Tue–Fri 4–7 p.m. (NOT during Fiserv events)", drinkSpecials: "$5 specials on tap beer, wine and rail mixers", foodSpecials: "Lunch specials run separately 11 a.m.–3 p.m. Mon–Fri", description: "Bass Pro–operated lodge with bowling, games and a rooftop \"Fire-Bar\" — right next to Fiserv Forum.", insiderTip: "HH is suspended on Fiserv Forum event nights — check the arena schedule before you commit. Family-friendly daytime.", tags: ["sports", "food", "rooftop"] },
  { name: "Café Hollander — Downer", region: "east-side", neighborhood: "East Side (Downer)", priceRange: "$$", address: "2608 N Downer Ave, Milwaukee, WI 53211", days: ["mon", "tue", "wed", "thu"], daysLabel: "Mon–Thu 3–5 p.m.", drinkSpecials: "50% off Lowlands Brewing drafts, Bier of the Month, wine, specialty mules, sangria", foodSpecials: "Drink-focused HH (no published food deals)", description: "Belgian grand-café with a long beer list and a Downer Ave patio. Lowlands Brewing collaborations are the move at half off.", insiderTip: "Sit on the patio when weather allows. Try a Bier of the Month at half price.", tags: ["beer", "wine", "international", "rooftop"] },
  { name: "Palomino Bar", region: "bay-view", neighborhood: "Bay View", priceRange: "$", address: "2491 S Superior St, Milwaukee, WI 53207", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4–7 p.m. + always-on $6 tap-and-shot combo", drinkSpecials: "$2 PBR cans · $1 off taps · Always-on $6 tap-beer-and-a-shot combo (rotating)", foodSpecials: "Southern menu available (not part of HH)", description: "Honky-tonk dive on the south end of Bay View. Southern food, patio, classic Bay View energy.", insiderTip: "The $6 beer-and-shot combo is one of the best dive deals in the city — and it's always on, not just during HH.", tags: ["beer", "cocktails"] },
  ...
  { name: "At Random", region: "bay-view", neighborhood: "Bay View", priceRange: "$$", address: "2501 S Delaware Ave, Milwaukee, WI 53207", days: ["tue", "wed", "thu"], daysLabel: "Tue–Thu 5–7 p.m.", drinkSpecials: "$8 ice cream cocktails (regularly $13)", foodSpecials: "No kitchen — drinks only", description: "Historic cocktail lounge since 1964. The ice cream cocktails are the calling card — and the HH discount makes them genuinely cheap.", insiderTip: "Dim, vintage, no kids allowed. The Pink Squirrel and Tin Roof are the orders. Cash adds to the vibe.", tags: ["cocktails"] },
  ...
  { name: "Avli", region: "brewers-hill", neighborhood: "Brewer's Hill", priceRange: "$$", address: "1818 N Hubbard St, Milwaukee, WI 53212", days: ["sun", "mon", "tue", "wed", "thu", "fri"], daysLabel: "Sun–Fri 4–6 p.m. (closed Sat HH)", drinkSpecials: "HH menu of cocktails, wines and small plates (call to confirm pricing)", foodSpecials: "Greek meze small plates featured", description: "Greek small-plates restaurant with a wine-forward bar. The patio hosts Tuesday Backyard BBQs in season (4–9 p.m.).", insiderTip: "The patio is the right call when weather allows. Sunday HH is rare in Milwaukee — Avli is one of the few.", tags: ["wine", "cocktails", "international", "food"] },
  { name: "Café Corazón — Bay View", region: "bay-view", neighborhood: "Bay View", priceRange: "$$", address: "2394 S Kinnickinnic Ave, Milwaukee, WI 53207", days: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], daysLabel: "Daily 3–6 p.m. (Tuesdays: HH drink prices all day)", drinkSpecials: "$7 house margarita, $7 paloma, $6 sangria, $1 off Mexican lagers", foodSpecials: "Mole Monday · Taco Tuesday (Tu y Yo benefit) · Vegan Thursday ($1 off vegan plates)", description: "Mexican neighborhood favorite with the city's most reliable Sunday HH — every day, 3–6 p.m.", insiderTip: "Tuesday is all-day HH pricing — Taco Tuesday makes it a no-brainer.", tags: ["cocktails", "food", "international"] },
  { name: "BelAir Cantina — Water St", region: "east-side", neighborhood: "Lower East Side (Brady-adjacent)", priceRange: "$$", address: "1935 N Water St, Milwaukee, WI 53202", days: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], daysLabel: "Daily 3–7 p.m. + late-night 9–11 p.m. (Water St)", drinkSpecials: "Late-night (Water St): $5 margaritas, $3 tequila shots, $6 specialty cocktails", foodSpecials: "Late-night: $6 queso blanco fundido, $5 nachos, $3 walkin' tacos, $5 guacamole · $2 Taco Tue & Thu · Burrito Mon 25% off", description: "Mexican spot with one of the city's only real late-night HH windows — 9–11 p.m. specifically at the Water St location.", insiderTip: "The 9–11 p.m. window is the move when you need late-night HH on the East Side. Burrito Monday 25% off is the daytime steal.", tags: ["cocktails", "food", "late-night", "international"] },
  { name: "The Diplomat", region: "east-side", neighborhood: "Brady Street", priceRange: "$$$", address: "815 E Brady St, Milwaukee, WI 53202", days: ["tue", "wed", "thu", "fri"], daysLabel: "Tue–Fri 4–6 p.m.", drinkSpecials: "Wine-focused HH menu (Wine Spectator award 5 years running) — call to confirm pricing", foodSpecials: "Shareable American small plates — chef Dane Baldwin (James Beard winner)", description: "Chef-driven Brady Street restaurant from James Beard winner Dane Baldwin. Often cited among Milwaukee's best HH for quality of bar food.", insiderTip: "Reservations not required at the bar for HH. The wine list is the reason — splurge on a glass during HH pricing.", tags: ["wine", "cocktails", "food"] },
  ...
  { name: "Movida at Hotel Madrid", region: "walkers-point", neighborhood: "Walker's Point", priceRange: "$$", address: "600 S 6th St, Milwaukee, WI 53204", days: ["wed", "thu", "fri"], daysLabel: "Wed–Fri 4–6 p.m. at the bar", drinkSpecials: "$9 sangrias (red/white/tequila) · Mon Sangria HH · Wine Wed (ladies' first glass free) · Take Two Thursdays", foodSpecials: "$1 tapas (jamon croquetas, pan con tomate) plus $3 and $5 tapas tiers", description: "Spanish tapas in the Hotel Madrid with a rooftop patio. The $1 tapas at the bar is one of the best food deals in Milwaukee.", insiderTip: "Live Flamenco Tuesdays. Hand-carved jamon. Rooftop in season.", tags: ["wine", "food", "international", "rooftop", "hotel"] },
  { name: "Iron Horse Hotel — Branded", region: "walkers-point", neighborhood: "Walker's Point (Iron Horse Hotel)", priceRange: "$$", address: "500 W Florida St, Milwaukee, WI 53204", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon–Fri 4–6 p.m.", drinkSpecials: "$4 tall boys · $5 off specialty cocktails · Half-off house wine and house liquor pours", foodSpecials: "Half-off apps (including deviled eggs)", description: "The Iron Horse Hotel's pub-style HH with pool, shuffleboard, foosball and arcade games. Patio at The Yard expands the HH in season.", insiderTip: "Walk to Brenner Brewing or Bryant's after — Walker's Point is dense around the Iron Horse.", tags: ["cocktails", "beer", "food", "hotel"] },
  { name: "Steny's Tavern & Grill", region: "walkers-point", neighborhood: "Walker's Point", priceRange: "$$", address: "800 S 2nd St, Milwaukee, WI 53204", days: ["mon", "tue", "wed", "thu", "fri"], daysLabel: "Mon all day; Tue–Fri 3–7 p.m. (\"Milwaukee's longest happy hour\")", drinkSpecials: "$1 off mixed drinks · $2 off pitchers · $0.50–$0.75 off taps · $5 Bloodys", foodSpecials: "Sports-bar / pizza menu (no formal HH food deals)", description: "Walker's Point sports bar staple — Bucks shuttle bar, Packers crowd, big patio. Monday is HH all day.", insiderTip: "Steny's also runs game-day shuttles to AmFam Field for Brewers games — perfect HH-then-game combo.", tags: ["beer", "sports", "late-night"] },
  { name: "Boone & Crockett", region: "walkers-point", neighborhood: "Walker's Point (riverfront)", priceRange: "$$", address: "818 S Water St, Milwaukee, WI 53204", days: ["sun", "wed", "thu", "fri"], daysLabel: "Sunday all-day HH; weekday HH within Wed–Fri 4 p.m.–2 a.m.", drinkSpecials: "Sun: $5 Manhattans with Luxardo cherry · Weekday HH cocktail specials (call to confirm)", foodSpecials: "Taco Moto food truck on-site (not part of HH)", description: "Cocktail bar with one of the biggest riverside patios in the city. Sunday all-day HH is the standout — perfect end-of-weekend move.", insiderTip: "The riverfront patio is a hidden gem. Sundays are the right call — most other spots don't run Sunday HH.", tags: ["cocktails", "rooftop"] },
  ...
  { name: "Story Hill BKC", region: "west-side", neighborhood: "Story Hill (just west of MKE)", priceRange: "$$", address: "5100 W Bluemound Rd, Milwaukee, WI 53208", days: ["tue", "wed", "thu", "fri", "sat"], daysLabel: "Tue–Sat 2–6 p.m. (Mid-Day Menu 3–5 p.m.)", drinkSpecials: "$2 off taps — beer AND tap craft cocktails", foodSpecials: "Mid-Day food menu 3–5 p.m.", description: "Neighborhood bistro with a 4-hour weekday HH window — one of the longest in this guide. Tap cocktails are the differentiator.", insiderTip: "Tap cocktails at $2 off are a rare find. Mid-Day food window (3–5) overlaps perfectly with the drink HH.", tags: ["beer", "cocktails", "food"] },
  { name: "Three Lions Pub", region: "suburbs", neighborhood: "Shorewood", priceRange: "$$", address: "4515 N Oakland Ave, Shorewood, WI 53211", days: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], daysLabel: "Daily 4–6 p.m.", drinkSpecials: "Up to 40% off taps, wine, specialty cocktails · Wed $5 pints of 3 Sheeps + $3 Lemon Drop shots + $5 Deep Eddy Bombs · Fri \"Old Fashioned Friday\" $6 all day · Thu $1 traditional wings", foodSpecials: "Up to 40% off appetizers · Shorewood workers 15% off food before 5 p.m. Fridays", description: "British pub with a 7-day-a-week HH — the most consistent suburban option. Long beer list and pub trivia Wednesday.", insiderTip: "Old Fashioned Friday ($6 all day) is the trip-up to Shorewood worth making. 40% off is steep — the deal is real.", tags: ["beer", "cocktails", "food", "weekend"] },
...
const faqs = [
  {
    ...
    answer: "Top all-around Milwaukee happy hour deals include Aperitivo (flat $8 wines/cocktails/small plates Tue–Thu 4–6 + Fri 4–5), Black Sheep ($5 Stoli martinis + Four Roses Manhattans + house wine, $10 cheese board Mon–Thu), Maxie's ($2 oysters, $9 select apps, $1 off all drinks Mon–Sat 4–6), Hooligan's ($1 off taps/bottles/wine + half-price apps Mon–Fri 4–7), Tupelo Honey ($3–$5 drinks + half-off starters Mon–Fri 3–6 with themed weeknights), Lupi & Iris ($4 beer / $7 wine / $9 cocktails Mon 3–8:30 + Tue–Fri 3–6), and Three Lions Pub in Shorewood (daily 4–6 with up to 40% off everything)."
  },
  {
    question: "What time does happy hour start in Milwaukee?",
    answer: "Most Milwaukee HHs run weekday 4–6 p.m. The earliest starts are Camino (2 p.m. Mon–Fri), Story Hill BKC (2 p.m. Tue–Sat) and Tre Rivali (2 p.m. Mon–Fri at the Kimpton Journeyman). The Wicked Hop runs Mon–Thu from 11 a.m. open through 7 p.m. The longest single-day HH in the city is Lupi & Iris on Mondays (3 p.m.–8:30 p.m.). For late-night, BelAir Cantina Water St runs a 9–11 p.m. window, and Miller Time Pub runs 10 p.m.–midnight Mon–Thu."
  },
  {
    question: "Where is happy hour open on Sunday in Milwaukee?",
    answer: "Sunday happy hour is rare in Milwaukee. Confirmed Sunday HH spots: Von Trier (daily 4–6 p.m. — includes Sunday), The Vanguard (daily bourbon deal), Café Corazón Bay View (daily 3–6 p.m.), Foundation Bar in Riverwest (daily 5–10 p.m.), Lost Whale Bay View (daily 4–6 p.m.), BelAir Cantina Water St (daily 3–7 p.m.), Three Lions Pub Shorewood (daily 4–6 p.m.), Avli Brewer's Hill (Sun–Fri 4–6), Bryant's Cocktail Lounge (Sun–Thu ~5–7), and Boone & Crockett (Sunday all-day HH — the city's standout Sunday move with $5 Luxardo Manhattans)."
  },
  {
    question: "Where can I get cheap drinks in Milwaukee?",
    answer: "For pure value: Hooligan's Super Bar on the East Side ($1 off taps/bottles/wine, $2 off mixers Mon–Fri 4–7 p.m.), Palomino Bar in Bay View ($2 PBR cans, $6 beer-and-shot combo always), Foundation Bar in Riverwest ($3 taps and rails 5–10 p.m. daily), Camino in Walker's Point (2-for-1 tall boys + half-off pierogi Mon–Fri 2–5 p.m.), The Vanguard ($2 PBR/Rhinelander/Milwaukee Classic Lager always), and Miller Time Pub downtown ($3 rails / $3 Miller drafts Mon–Thu 4–7). Burnhearts' $8 four-pour sampler is the craft-beer value play in Bay View."
  },
  {
    question: "What Milwaukee bars have the best happy hour food?",
    answer: "Movida at Hotel Madrid in Walker's Point runs $1 tapas at the bar (Wed–Fri 4–6) — arguably the best food deal in the city. Maxie's has $2 oysters and $9 select apps Mon–Sat 4–6. Tupelo Honey has half-off starters plus $4 HH bites Mon–Fri 3–6. Hooligan's runs half-priced apps Mon–Fri 4–7. BelAir Cantina Water St's late-night 9–11 p.m. brings $3 walkin' tacos and $5 nachos. The Wicked Hop runs half-off apps Mon–Thu 3–5. Camino does half-off pierogi Mon–Fri 2–5. Black Sheep's $10 cheese board (Mon–Thu) is the wine-pairing classic."
  },
  {
    question: "What are the best rooftop and patio happy hours in Milwaukee?",
    answer: "The Outsider rooftop atop the Kimpton Journeyman in the Third Ward (Mon–Fri 4–6, $10 fruit-infused signature cocktails) is the city's best rooftop HH. Uncle Buck's rooftop \"Fire-Bar\" in the Deer District has the Tue–Fri 4–7 HH (suspended on Fiserv event nights). Boone & Crockett's riverside patio in Walker's Point is the standout outdoor cocktail bar — Sunday all-day HH. Von Trier's biergarten and Café Hollander Downer's patio cover the East Side. Movida's rooftop at Hotel Madrid hosts $1 tapas Wed–Fri. Lost Whale's Bay View backyard runs daily 4–6 with half-off taps and cocktails."
  },
  {
    question: "What hotel bars have happy hour in Milwaukee?",
    answer: "Mason Street Grill inside The Pfister (Mon–Fri 4–6:30, $2 drafts / $3 wells / $5 martinis / $5–$7 wine + live nightly jazz). The Bar at Saint Kate Arts Hotel (Mon–Thu 3–5, wine/beer/apps deals + live music starting at 5). The Outsider at Kimpton Journeyman (rooftop, Mon–Fri 4–6). Tre Rivali at Kimpton Journeyman (Mon–Fri 2–6 bar/patio HH + half-price-bottle Wednesdays). Branded at The Iron Horse Hotel in Walker's Point (Mon–Fri 4–6, $4 tall boys + half-off house wine/liquor + half-off apps). Movida at Hotel Madrid (Wed–Fri 4–6, $1 tapas)."
  },
  {
    question: "Where can I find late-night happy hour in Milwaukee?",
    answer: "True late-night HH is rare in Milwaukee. Confirmed: Miller Time Pub & Grill downtown runs 10 p.m.–midnight Mon–Thu with $3 Miller High Life taps and shots. BelAir Cantina Water St runs a 9–11 p.m. late-night HH (Lower East Side) with $5 margaritas, $3 tequila shots, $6 specialty cocktails, plus discounted snacks. Foundation Bar in Riverwest runs HH till 10 p.m. daily. Camp Bar Shorewood adds 7–10 p.m. nightly specials after the regular HH. Steny's Tavern in Walker's Point is HH-leaning all evening Mon–Fri."
  },
  {
    question: "Where is happy hour near Fiserv Forum and the Deer District?",
    answer: "Walking distance from Fiserv: Uncle Buck's Fish Bowl on N Dr Martin Luther King Jr Dr has a Tue–Fri 4–7 p.m. HH ($5 tap beer, wine and rail mixers) — but the HH is NOT available during Fiserv Forum events, so check your game time. Miller Time Pub & Grill at 5th & Wisconsin (Mon–Thu 4–7) adds $5 Miller Lite drafts during Brewers/Bucks home games. Mason Street Grill at The Pfister and The Bar at Saint Kate are both ~10-minute walks east. Several Deer District spots that older guides reference (Punch Bowl Social, MECCA Sports Bar, Good City Deer District) have closed — these are no longer options."
  },
  {
    question: "Which Milwaukee happy hour spots have specialty deals on specific days?",
    answer: "Tupelo Honey: Tue $3 martinis, Wed half-off wine bottles, Thu $6 margaritas. Three Lions Pub Shorewood: Wed $5 pints of 3 Sheeps + $3 Lemon Drops + $5 Deep Eddy Bombs; Fri \"Old Fashioned Friday\" $6 all day; Thu $1 traditional wings. Tre Rivali: half-price bottles of Mediterranean wine on Wednesdays. Movida at Hotel Madrid: Wine Wed (ladies' first glass free), Take Two Thursday tapa+cocktail pairing. Boone & Crockett: Sun all-day HH ($5 Luxardo Manhattans). The Wicked Hop: Tue all-day $7 cocktails + $9 apps. Steny's: HH all day Monday."
  },
];

const BY_DAY_BEST = {
  mon: ["Hooligan's Super Bar", "Steny's Tavern & Grill", "Lupi & Iris", "Three Lions Pub", "Black Sheep"],
          ...
          <section id="at-a-glance" style={{ marginBottom: "56px", scrollMarginTop: "80px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "12px" }}>
              {[
                ...
                { label: "Longest single-day HH", value: "Lupi & Iris Monday (3 p.m.–8:30 p.m.)" },
                ...
                { label: "Best late-night (after 9 p.m.)", value: "BelAir Water St (9–11), Miller Time (10–12), Foundation Bar (till 10)" },
