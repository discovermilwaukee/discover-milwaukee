...
const creators = [
  { ig: "herodw", tt: "herodw", name: "Hero DW", category: "news", rank: 7750000, bio: "A Wisconsin comedian and content creator whose skits and social experiments rack up millions of views. Big-hearted comedy with Midwest roots." },
  { ig: "trixiemattel", tt: "trixie", name: "Trixie Mattel", category: "music", rank: 6800000, bio: "Milwaukee-born and Wisconsin-raised, Trixie Mattel went from local stages to winning RuPaul's Drag Race, selling out music tours, and building a cosmetics empire. The 414's biggest drag superstar." },
  { ig: "tristanjass", tt: "tristanjass22", name: "TJass (Tristan Jass)", category: "sports", rank: 5600000, bio: "A Kenosha-bred basketball creator whose between-the-legs layups built a global following. Southeast Wisconsin's hooper-turned-internet phenomenon." },
  ...
  { ig: "lakeyah", tt: "lakeyah", name: "Lakeyah", category: "music", rank: 2100000, bio: "A Milwaukee-born rapper signed to Quality Control and Motown, turning city grit into national bars. Homegrown talent on a much bigger stage." },
  { ig: "schizophrenichippie", tt: "schizophrenichippie", name: "Kody Green", category: "lifestyle", rank: 1700000, bio: "A Wisconsin mental-health advocate living openly with schizophrenia and reaching millions with honesty and hope. Hard conversations, handled with heart." },
  { ig: "itsmyaap", tt: "myamyaa8", name: "Myaap", category: "music", rank: 821600, bio: "A Milwaukee rapper with a fast-rising following and a sound built for the city. 414 energy, full volume." },
  { ig: "emiliexfosters", tt: "emiliexfosters", name: "Emilie Rackovan", category: "lifestyle", rank: 745900, bio: "A Milwaukee mom sharing the real, joyful story of fostering and adoption. Family life with the camera rolling." },
  { ig: "realbalanced", tt: "realbalanced", name: "Sara Nelson", category: "food", rank: 627800, bio: "The Wisconsin recipe developer behind Real Balanced, making low-carb and keto cooking actually doable. Tested recipes, no fuss." },
  { ig: "khloekuriatnyk", tt: "khloekuriatnyk", name: "Khloe Kuriatnyk", category: "lifestyle", rank: 448500, bio: "A Milwaukee creator sharing style, motherhood, and everyday life with a loyal following. Relatable, polished, and all MKE." },
  { ig: "ike_wynter", tt: "ike_wynter", name: "Ike Wynter", category: "news", rank: 384200, bio: "A Milwaukee comedian and creator turning everyday city life into must-watch comedy. Local humor, wide reach." },
  ...
  { ig: "discovermilwaukee", tt: "discovermilwaukee", name: "Discover Milwaukee", category: "news", rank: 102300, bio: "That's us. Discover Milwaukee is your insider's guide to the city — the events, eats, and people who make the 414 worth talking about. Hi from this side of the screen." },
  { ig: "kristinbrey", tt: "asgoeswisconsin", name: "Kristin Brey", category: "news", rank: 95300, bio: "The voice behind 'As Goes Wisconsin,' cutting through the noise on state politics with sharp, no-spin commentary. Wisconsin's plain-talk host." },
  { ig: "reynoldsgareth", tt: "reynoldsgareth", name: "Gareth Reynolds", category: "news", rank: 80500, bio: "A Wisconsin-bred comedian, actor, and co-host of the hit history-comedy podcast 'The Dollop.' Stand-up wit with Midwest DNA." },
  { ig: "lill.waukee", tt: "lillwaukee", name: "Lillwaukee", category: "food", rank: 70200, bio: "A Milwaukee food account hunting the city's best plates and hidden gems. Your next craving probably lives here." },
  ...
  { ig: "mkemaniaci", tt: "mkemaniaci", name: "Maniaci", category: "news", rank: 53400, bio: "A Milwaukee personality and creator with a fast-growing audience and a feel for what the city's talking about." },
  ...
  { ig: "milwaukeeuncut", tt: "milwaukeeuncutpod", name: "Milwaukee Uncut", category: "news", rank: 39300, bio: "A Milwaukee podcast going deep with the people shaping the city — unfiltered conversations, local lens." },
  ...
  { ig: "wisconsincheeseplease", tt: "wisconsincheeseplease", name: "Sam Buschman", category: "food", rank: 35676, bio: "A Wisconsin creator celebrating the state's one true love: cheese. Curds, pairings, and dairy-state pride." },
  ...
  { ig: "andreaboehlke", tt: "andreaboehlke", name: "Andrea Boehlke", category: "news", rank: 32797, bio: "A Wisconsin-raised TV host and three-time 'Survivor' competitor turned media personality. Random Lake roots, national screen time." },
  ...
  { ig: "cookingwithkelli", tt: "cookingwith.kelli", name: "Kelli Calkins", category: "food", rank: 24536, bio: "A Milwaukee home cook sharing approachable recipes and kitchen wins. Real food, made doable." },
  ...
  { ig: "munchinginmilwaukee", tt: "munchinginmilwaukee", name: "Munching in Milwaukee", category: "food", rank: 16253, bio: "Eating across Milwaukee one spot at a time, with the recs to prove it. The city's menu, sampled." },
  { ig: "imcertifiedtrapper", tt: "imcertifiedtrapper", name: "Certified Trapper", category: "music", rank: 15925, bio: "A Wisconsin rapper whose offbeat style broke out online. Viral hooks, homegrown origin." },
