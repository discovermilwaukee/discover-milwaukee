...
const activities = {
  ...
  entertainment: [
    ...
    },
    {
      ...
      description: "12 lanes of axe throwing with coaches to help you perfect your technique. Great for groups, team building, or just a different kind of date night. No experience needed.",
      highlights: "12 lanes, Coaching included, Group friendly",
      insiderTip: "Book ahead for weekend evenings. First-timers improve quickly with coaching.",
      bestFor: "Groups, dates, team building, active fun",
      duration: "1-2 hours",
    },
    {
      ...
      type: "Social Gaming",
      price: "$$",
      address: "1122 E Juneau Ave, Milwaukee, WI 53202",
      description: "An all-in-one entertainment complex featuring bowling, arcade games, ping pong, karaoke rooms, and a full restaurant and bar. Easy to spend an entire rainy afternoon here.",
      highlights: "Bowling, Arcade, Karaoke, Full bar and restaurant",
      insiderTip: "The food is surprisingly good. Karaoke rooms are great for groups.",
      bestFor: "Groups, all-ages fun, food and drinks",
      duration: "2-4 hours",
    },
  ],
  breweries: [
    ...
    },
    {
      ...
      description: "Take a tour of the brewing operation with samples of their various styles. Saturday open houses include samples and Q&A sessions with the brewers. Great for beer nerds who want to learn.",
      highlights: "Brewing education, Beer samples, Saturday open house",
      insiderTip: "The open house format lets you ask detailed questions. Come curious.",
      bestFor: "Beer enthusiasts, learning experience, rainy Saturday",
...
const faqs = [
  {
    ...
    answer: "The Milwaukee Public Museum, Discovery World, and Milwaukee Art Museum offer hours of indoor entertainment. For active fun, try Sky Zone trampoline park or Punch Bowl Social. Brewery tours at Lakefront or Milwaukee Brewing Company combine entertainment with Milwaukee culture.",
  },
  {
  ...
  },
  {
    ...
    answer: "The Oriental Theatre offers films in a stunning historic setting. Bryant's Cocktail Lounge provides intimate ambiance for drinks. The Harley-Davidson Museum appeals to non-riders too. Axe throwing at AXE MKE is a different kind of date.",
  },
  {
