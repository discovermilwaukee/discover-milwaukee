...
const WEEKEND_DATA = {
  ...
  featuredEvents: [
    ...
    },
    {
      ...
      startDateISO: '2026-04-17T17:00:00-05:00',
      endDateISO: '2026-04-18T21:00:00-05:00',
    ...
    },
    {
      ...
      date: 'April 16-19, 2026',
      startDateISO: '2026-04-16T10:00:00-05:00',
      endDateISO: '2026-04-19T17:00:00-05:00',
    ...
    },
    {
      ...
      date: 'April 18, 2026',
      startDateISO: '2026-04-18T07:00:00-05:00',
      time: '7:00 AM',
    ...
    },
    {
      ...
      venue: 'Fiserv Forum',
      date: 'April 18, 2026',
      startDateISO: '2026-04-18T19:00:00-05:00',
      time: '7:00 PM',
...
function generateSchemaData() {
  const articleSchema = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': 'https://www.discover-milwaukee.com/this-weekend-milwaukee',
    },
    about: {
      '@type': 'City',
      name: 'Milwaukee',
  ...
  return (
    <>
      <Head>
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://www.discover-milwaukee.com/this-weekend-milwaukee" />
        ...
        />
        <meta property="og:url" content="https://www.discover-milwaukee.com/this-weekend-milwaukee" />
