...
const faqs = [
  ...
  },
  {
    ...
    answer: `Email your resume to ${APPLY_EMAIL} with "Social Media Intern Application" and your name in the subject line. Applications are reviewed on a rolling basis through August 30, 2026.`,
  },
];
...
<h3>How to Apply</h3>
<p>Email your resume to ${APPLY_EMAIL} with "Social Media Intern Application" and your name in the subject line. Applications are reviewed on a rolling basis through August 30, 2026.</p>
`;
        ...
        <main style={{ maxWidth: "820px", margin: "0 auto", padding: "48px 24px" }}>
          ...
          <section id="apply" style={{ background: `linear-gradient(135deg, ${c.green1} 0%, ${c.green2} 100%)`, padding: "40px 32px", borderRadius: "18px", textAlign: "center", marginBottom: "48px", scrollMarginTop: "80px" }}>
            ...
            <p style={{ color: c.beige, fontSize: "15px", lineHeight: 1.7, marginBottom: "24px", fontFamily: BODY, maxWidth: "560px", marginLeft: "auto", marginRight: "auto" }}>
              Bonus points: send links to any social accounts or content you&apos;ve made, and tell us one Milwaukee brand you&apos;d love to see us work with. Applications are reviewed on a rolling basis through <strong>August 30, 2026</strong>.
            </p>
            <ApplyButton />
          </section>
