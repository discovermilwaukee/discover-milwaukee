...
const atAGlance = [
  ...
  { label: "Kids under 3", value: "Free, every day" },
...
const exhibits = [
  {
    ...
    what: "Largest single addition in zoo history. The all-female herd of three African savanna elephants — Belle, Brittany and Ruth — share a 1.6-acre outdoor yard and a 20,000 sq ft Care Center. Elephant Habitat enrichment talks Mon, Tue, Thu, Fri at 11:30 a.m.",
  ...
  {
    name: "Adventure Africa Phase III — Rhino Care Center",
  ...
  {
    name: "Small Mammals Building",
    what: "Bats, rodents, marsupials, fennec foxes and other small mammal species across themed nocturnal and diurnal zones. Indoor, year-round.",
    best: "Anytime — the nocturnal exhibit is most rewarding when your eyes have a minute to adjust.",
  },
  {
...
const faqs = [
  ...
  { question: "Do you still have elephants at the Milwaukee County Zoo?", answer: "Yes. The zoo's all-female African savanna elephant herd is three: Belle, Brittany and Ruth. They live in the Adventure Africa complex, which opened in 2019 and is the largest physical change to the zoo since its 1961 move to this site. The 1.6-acre outdoor yard is paired with a 20,000-square-foot Elephant Care Center. Keeper enrichment talks are scheduled Monday, Tuesday, Thursday and Friday at 11:30 a.m." },
