...
const festivals = [
  ...
  },
  {
    ...
    description: "A lively downtown-Waukesha street celebration bringing Bavarian music, brats, spanferkel, and wiener schnitzel to the courthouse lawn. Compact and walkable, it's an easy county-seat alternative to the bigger Milwaukee fests.",
    bestFor: "A walkable, smaller-scale Oktoberfest",
    address: "Waukesha County Courthouse, 515 W Moreland Blvd, Waukesha, WI 53188",
  },
  {
  ...
  },
  {
    ...
    description: "More than 40 handcrafted illuminated lantern displays — dragons, glowing pagodas, enchanted oceans — line a three-quarter-mile path through Boerner Botanical Gardens after dark. Running nearly two months, it's one of the region's most spectacular fall-evening outings.",
...
const orchards = [
  ...
  },
  {
    ...
    address: "W220N10540 Amy Belle Rd, Germantown, WI 53022",
  },
  {
    name: "Apple Holler",
    where: "Sturtevant",
  ...
  },
  {
    ...
    where: "Waterford",
    type: "U-Pick Orchard",
    description: "A Racine County favorite with more than 40 apple varieties and a bakery turning out cider donuts, pies, and turnovers. Weekends add a corn maze and October pumpkin picking for a full fall outing.",
...
const pumpkins = [
  ...
  },
  {
    ...
    where: "New Berlin",
    type: "Pumpkin Patch · Family",
    description: "A close-to-Milwaukee New Berlin farm that leans hard into kid-friendly fun: a petting zoo with feeding trails, a 30-foot giant slide, barrel train, pedal-car raceway, merry-go-round, and pumpkin bowling. Parking and admission are free, with small charges for the play areas.",
    bestFor: "Younger kids and a free-admission visit",
    proTip: "The Big Backyard wristband costs a bit more Fri–Sun — a weekday visit saves money.",
  ...
  },
  {
    ...
    proTip: "Open daily except Tuesday in season — weekends are when the free field hayrides run.",
    address: "County F & Hwy 67, Walworth, WI 53184",
  },
  {
...
const haunted = [
  ...
  },
  {
    ...
    where: "Racine",
    type: "Scary · Indoor Industrial",
    description: "Billed as the scariest haunt in the Racine–Milwaukee–Kenosha corridor, set inside an old factory along the Root River. Winding industrial corridors and aggressive actors make it a strong stop for south-suburban thrill-seekers.",
    bestFor: "An industrial indoor scare 30–40 minutes south",
    proTip: "Pair it with a Kenosha-area haunt for a full night out.",
    address: "615 S Marquette St, Racine, WI 53403",
  },
  {
  ...
  },
  {
    ...
    description: "A guided, candlelit after-dark walk through the 1892 beer baron's mansion, exploring darkness, loss, hidden compartments, and seldom-seen lower-level spaces. Atmospheric rather than a jump-scare haunt — great for those who like history with their Halloween.",
...
const foliage = [
  ...
  },
  {
    ...
    description: "Twelve formal gardens sit within an arboretum of maples, oaks, and ornamental trees that glow in autumn, all inside the 660-acre Whitnall Park. Fall is a prime, less-crowded window before the gardens close for the year in early November.",
    bestFor: "A curated, designed fall display",
    proTip: "The gardens close for the season in early November — go in October and extend into Whitnall Park's trails.",
  ...
  },
  {
    ...
    description: "A 45-foot tower atop the highest point in Waukesha County looks out over a glaciated forest ablaze in reds and golds, with 20-plus miles of trails from paved paths to challenging grass loops. Climb the 70 steps for the payoff view.",
  ...
  },
  {
    ...
    where: "Waukesha",
    type: "Nature Center",
    description: "A 335-acre nature center with miles of boardwalk, paved, and dirt loops through restored prairie and remnant oak savanna that turns russet and gold. The longer Yellow Loop offers the fullest immersion, and prairie grasses add warm autumn tones.",
  ...
  },
  {
    ...
    address: "Parnell Tower Trailhead, County Rd U, Sheboygan County",
  },
  {
...
const foodDrink = [
  ...
  {
    name: "Good City Brewing — Oktoberfest",
    where: "Milwaukee (East Side)",
    type: "Brewery · Märzen",
    description: "Good City's Märzen is slightly sweet and biscuity with a spicy, herbal German-hop backbone — a beer that genuinely tastes like fall. The East Side taproom's restored building with roll-up garage doors and a rooftop bar makes it a warm perch for the first crisp evenings.",
    bestFor: "Märzen with a rooftop and a pretzel",
...
const timeline = [
  ...
  { month: "November", color: c.tan, items: ["China Lights runs through Nov 1", "Late apple varieties still available at some orchards", "Boerner gardens close for the season in early November", "Cozy supper-club and fireplace-bar season sets in", "First quiet, crisp days before the holidays"] },
];
...
const confirmedEvents = [
  ...
  { name: "Waukesha Oktoberfest", start: "2026-09-25", end: "2026-09-26", venue: "Waukesha County Courthouse", street: "515 W Moreland Blvd", city: "Waukesha", zip: "53188" },
