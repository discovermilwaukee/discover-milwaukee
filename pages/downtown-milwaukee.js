...
const restaurants = [
  ...
  },
  {
    ...
    description: "Upscale seafood restaurant in the heart of downtown serving fresh catches and creative preparations. The raw bar is excellent, and the atmosphere strikes the right balance of sophisticated and welcoming.",
    mustTry: "Raw bar, fresh fish preparations, craft cocktails",
    bestFor: "Date nights, business dinners, seafood lovers",
    insiderTip: "The raw bar happy hour is one of downtown's best deals.",
  },
  {
    name: "Mo's Irish Pub",
    cuisine: "Pub Fare",
  ...
  },
  {
    ...
    cuisine: "Historic Hotel (Victorian Lobby)",
    priceRange: "$$",
    address: "424 E Wisconsin Ave, Milwaukee, WI 53202",
    description: "Milwaukee's grand Victorian hotel features a stunning lobby worth visiting even if you're not staying. The Blu rooftop bar offers great views, and Café at the Pfister serves solid fare. A downtown landmark since 1893.",
    mustTry: "Drinks at Blu rooftop, lobby tour, afternoon tea",
    bestFor: "Special occasions, history lovers, rooftop drinks",
    insiderTip: "The lobby's Victorian art collection is free to view—just walk in.",
  },
];
        ...
        <main style={{ maxWidth: "800px", margin: "0 auto", padding: "48px 24px" }}>
          ...
          <section id="key-facts" aria-labelledby="key-facts-heading" style={{ backgroundColor: c.cream, border: `1px solid ${c.beige}`, padding: "20px 24px", borderRadius: "14px", marginBottom: "32px", scrollMarginTop: "80px" }}>
            ...
            <dl style={{ display: "grid", gridTemplateColumns: "max-content 1fr", gap: "10px 18px", margin: 0, fontSize: "14px", lineHeight: 1.5 }}>
              ...
              <dd style={{ color: "#444", margin: 0 }}>Downtown Milwaukee Guide</dd>
              <dt style={{ color: c.green1, fontWeight: "700" }}>Featured</dt>
              <dd style={{ color: "#444", margin: 0 }}>6 downtown milwaukee verified across Milwaukee</dd>
              <dt style={{ color: c.green1, fontWeight: "700" }}>Top picks</dt>
              <dd style={{ color: "#444", margin: 0 }}>Mader's German Restaurant, Elsa's on the Park, Safe House, Third Coast Provisions, Mo's Irish Pub</dd>
